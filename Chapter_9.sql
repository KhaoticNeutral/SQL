...
FROM 'C:\Users\Public\MyWork\MPI_Directory_by_Establishment_Name.csv'
...
LTER TABLE meat_poultry_egg_inspect ADD COLUMN st_copy varchar(2);
...
COPY state_regions
FROM 'C:\Users\Public\MyWork\state_regions.csv'
WITH (FORMAT CSV, HEADER, DELIMITER ',');
